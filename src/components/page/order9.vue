            ...
            <div>
                <a-row>
                    <a-col :span="4">
                        <div class="line">
                            <ul class="left-menu">
                                <li @click="routeLink(1)">面料</li>
                                <li @click="routeLink(2)">西服里</li>
                                <li class="active" @click="routeLink(3)">马甲里</li>
                                <li @click="routeLink(4)">底领</li>
                                <li @click="routeLink(5)">纽扣</li>
                            </ul>
                        </div>
                    </a-col>
                    <a-col :span="20">
                        <div class="content">
                            ...
                            <div class="type-main">
                                ...
                                >
                                    ...
                                    <p class="type-font-style">LV003</p>
                                </a-card>
                                <a-card
                                    style="
                                        width: 156px;
...
export default {
    ...
    methods: {
        ...
        routeLink(val) {
            if (val === 1) {
                this.$router.push({ path: '/order7' });
            } else if (val === 2) {
                this.$router.push({ path: '/order8' });
            } else if (val === 3) {
                this.$router.push({ path: '/order9' });
            } else if (val === 4) {
                this.$router.push({ path: '/order2' });
            } else if (val === 5) {
                this.$router.push({ path: '/order3' });
            }
        },
        onChange() {}
    }
