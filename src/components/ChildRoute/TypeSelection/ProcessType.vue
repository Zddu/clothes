    ...
    export default {
        ...
        methods: {
            ...
            getCategoryinfo() {
                queryCategoryinfo({
                    template_id: '5',
                    category_ids: this.$store.getters.getClothingCategory+","+this.$store.getters.getClothingType+","+this.$store.getters.getClothingStyle+","+this.$store.getters.getClothingFormat
                }).then((res) => {
